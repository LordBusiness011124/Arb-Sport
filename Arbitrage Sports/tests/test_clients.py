...
def test_kalshi_prefilter_accepts_market_title_winner_shape_with_event_title_fallback() -> None:
    reason = _matchable_market_rejection_reason(
        event={
            "title": "Boston Celtics vs New York Knicks",
            "sub_title": "April 20, 2026",
        },
        market={
            "market_type": "binary",
            "title": "Will Boston Celtics beat New York Knicks?",
            "yes_sub_title": "Yes",
            "no_sub_title": "No",
            "rules_primary": "",
        },
