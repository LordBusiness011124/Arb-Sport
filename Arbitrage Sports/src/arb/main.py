...
def _build_matchable_kalshi_market(
    ...
    teams = _parse_matchup_from_event_subtitle(snapshot.event_sub_title)
    if teams is None:
        return None
...
def _parse_matchup_from_event_subtitle(event_sub_title: str) -> tuple[str, str] | None:
    """Extract a clean team-vs-team pairing from an event subtitle."""
